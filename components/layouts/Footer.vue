    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:py-12 lg:px-8">
      <div class="lg:grid lg:grid-cols-3 lg:gap-8">
        <div class="space-y-8 lg:col-span-1">
          <img class="h-16" src="/images/bds-logo.png" alt="Bds Corporation">
          <p class="text-gray-500 text-base">
            Bds Corporation is a well renowned conglomerate in Bangladesh having diversified business.
          </p>
        ...
        <div class="mt-12 md:grid md:grid-cols-2 md:gap-8 lg:mt-0 lg:col-span-2">
      ...
      <div class="mt-12 border-t border-gray-200 pt-8">
        <p class="text-base text-gray-400 xl:text-center">
          &copy; 2022 BDS Corporation. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
