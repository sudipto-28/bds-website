    ...
    <div class="relative">
      ...
      <div class="relative md:flex md:items-center">
        ...
        <div class="relative md:ml-10">
          <svg class="absolute top-0 left-0 transform -translate-x-8 -translate-y-24 h-36 w-36 text-indigo-200 opacity-50 hidden md:block" stroke="currentColor" fill="none" viewBox="0 0 144 144" aria-hidden="true">
