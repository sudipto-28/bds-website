<template>
  <div class=" pt-8 lg:pt-10">
    <h1 class="mb-0 text-3xl text-center font-extrabold text-gray-900 tracking-tight sm:text-4xl">
      ...
      <div class="2xl:container 2xl:mx-auto md:py-12 py-9">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-12 gap-14 lg:px-20 lg:py-12 py-10 md:px-12 px-4">
          ...
          <div class="">
            ...
            <h3 class="text-xl leading-5 dark:text-white font-semibold text-gray-800 mt-6">Mission</h3>
            <p class="text-base leading-6 font-normal dark:text-gray-300 text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">To prosper together with desire and action can be made customers, shareholders, and employee satisfaction and to contribute to a prosperous society.</p>
          </div>
          ...
          <div class="">
            ...
            <h3 class="text-xl leading-5 dark:text-white font-semibold text-gray-800 mt-6">Management Policy</h3>
            <p class="text-base leading-6 font-normal dark:text-gray-300 text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">To take up the challenges of Innovation and to respond to market needs as a diversified and multi-faceted trading company.</p>
          </div>
          ...
          <div class="">
            ...
            <h3 class="text-xl leading-5 dark:text-white font-semibold text-gray-800 mt-6">Business Domains</h3>
            <p class="text-base leading-6 font-normal dark:text-gray-300 text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">To extend logistics centered operations to support services vital to consumers and industry</p>
          </div>
          ...
          <div class="">
            ...
            <h3 class="text-xl leading-5 dark:text-white font-semibold text-gray-800 mt-6">Action Guideline</h3>
            <p class="text-base leading-6 font-normal dark:text-gray-300 text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">To deliver customer satisfaction with creativity, innovation, sincerity and gratitude, and to act in compliance with the law and ethics.</p>
          </div>
        </div>
      </div>
    </div>
